...
public class ShopMan extends AreaEntity implements Interactor,Inventory.Holder {
	...
	private boolean showDialog;
		...
		sprite =new RPGSprite("assistant.fixed",1.f,2.f,this,new RegionOfInterest(0,0,16,32));
...
private void updateItem() {
	...
	public List<DiscreteCoordinates> getFieldOfViewCells() {
		// TODO Auto-generated method stub
		return Collections.singletonList(getCurrentMainCellCoordinates().jump(getOrientation().toVector()).jump(getOrientation().toVector()));
	}
